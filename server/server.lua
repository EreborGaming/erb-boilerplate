...
-- function SourceHasPermission(source, permissionGroup)
--     local ace = false -- IsPlayerAceAllowed(source, 'vorpcore.showAllCommands')
...
--     if permissionGroup and Character.group == permissionGroup then
--         return true
--     else 
--         if Character.group == Config.GroupAdmin or Character.group == Config.GroupMod then
--             return true
--         end
--     end
...
--     -- Permission check
--     if not SourceHasPermission(_source) then
--         return 
--     end

--     print('Permission access')
--     -- Here you have access for permission
-- end)

-- RegisterServerEvent("erb-boilerplate:server:addChatSuggestions")
-- AddEventHandler("erb-boilerplate:server:addChatSuggestions", function()
--     local _source = source
--     -- Permission check
--     if not SourceHasPermission(_source) then
--         TriggerClientEvent("chat:removeSuggestion", _source, "/testchat")
--         return
--     end

--     TriggerClientEvent("chat:addSuggestion", _source, "/testchat", "Command description.", {{
--         name = "Id",
--         help = 'player ID'
--     }, {
--         name = "Group",
